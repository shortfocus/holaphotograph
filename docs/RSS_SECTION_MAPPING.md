...
| **compare** | 장비 비교 & 상세 분석 | 제목·카테고리에 비교, 상세, 분석, vs, 대비, 대조, 스펙, 후보, 추천, 가이드, 구매 포함 |
...
**장비 비교 & 상세 분석 (compare):** 제목 또는 카테고리에 `비교|상세|분석|vs|대비|대조|스펙|후보|추천|가이드|구매` 포함 시 `compare` 배열에 추가.
